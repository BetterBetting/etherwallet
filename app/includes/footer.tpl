<section class="pre-footer">
  <div class="container">
    <p>
      MyBetrWallet.com does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <p>
        &copy; 2018 Better Betting Foundation
      </p>
 ...
 -->
      <p>
        ...
        <a aria-label="twitter" title="twitter" href="https://twitter.com/BETRBetting" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="facebook" title="facebook" href="https://www.facebook.com/BETRBetting" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="medium" title="medium" href="https://medium.com/@betterbetting" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="linkedin" title="linkedin" href="https://www.linkedin.com/company/betterbetting/" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
